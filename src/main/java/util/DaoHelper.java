...
public class DaoHelper {
	...
	static {
		try {
			...
			prop.load(new FileInputStream("/Users/seung-gyu/workspace/web-workspace/app3/src/main/java/dao/sql.properties"));
//			prop.load(DaoHelper.class.getClassLoader().getResourceAsStream("sql.properties"));
